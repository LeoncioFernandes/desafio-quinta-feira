...
export default function Card({imagem, titulo, texto, preco}){
    return(
        <>
                ...
                <div className="w-[261px] h-[60px] sm:w-[454px] sm:h-[81px]">
                    ...
                    <div className="absolute bottom-0 right-0 w-[270px] sm:w-[468px]">
                        <div className="flex flex-row justify-between px-3 pt-2">
                            ...
                            <button className="flex w-[45px] h-[25px] items-center justify-center rounded-[4px] bg-[#000000] text-[#FFFFFF]">
